...
SDL_DYNAPI_PROC(float,SDL_GameControllerGetAxis,(SDL_GameController *a, SDL_GameControllerAxis b),(a,b),return)
...
SDL_DYNAPI_PROC(SDL_GameControllerData, SDL_GetControllerData, (SDL_GameController * a), (a), return)
SDL_DYNAPI_PROC(SDL_HapticData, SDL_GetHapticData, (SDL_Haptic * a), (a), return)
SDL_DYNAPI_PROC(Uint8,SDL_GameControllerGetButton,(SDL_GameController *a, SDL_GameControllerButton b),(a,b),return)
SDL_DYNAPI_PROC(Uint8, SDL_GameControllerGetHat, (SDL_GameController * a, int b), (a, b), return)
...
SDL_DYNAPI_PROC(SDL_Haptic*, SDL_HapticOpenFromController, (SDL_GameController * a), (a), return)
...
SDL_DYNAPI_PROC(int,SDL_GameControllerGetLED,(SDL_GameController * a, Uint8 *b, Uint8 *c, Uint8 *d), (a, b, c, d), return)
...
SDL_DYNAPI_PROC(int, SDL_JoystickGetLED, (SDL_Joystick * a, Uint8 *b, Uint8 *c, Uint8 *d), (a, b, c, d), return)
